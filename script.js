...
seeProjectBtnDesks[0].addEventListener("click", function () {
  headline.style.opacity = "0.4";
  headline.style.backgroundColor = "#C1C7D0";
  portfolioSection.style.display = "none";
  aboutSection.style.display = "none";
...
seeProjectBtnDesks[1].addEventListener("click", function () {
  headline.style.opacity = "0.4";
  headline.style.backgroundColor = "#C1C7D0";
  portfolioSection.style.display = "none";
  aboutSection.style.display = "none";
...
seeProjectBtnDesks[2].addEventListener("click", function () {
  headline.style.opacity = "0.4";
  headline.style.backgroundColor = "#C1C7D0";
  portfolioSection.style.display = "none";
  aboutSection.style.display = "none";
...
seeProjectBtnDesks[3].addEventListener("click", function () {
  headline.style.opacity = "0.4";
  headline.style.backgroundColor = "#C1C7D0";
  portfolioSection.style.display = "none";
  aboutSection.style.display = "none";
...
closeBtnDesk.addEventListener("click", function () {
  headline.style.opacity = "1";
  headline.style.backgroundColor = "#fff";
  portfolioSection.style.display = "block";
  aboutSection.style.display = "block";
